...
#define _CHECK_EVENT_STATUS_FAIL "Fail to check status of the event for the socket."
...
int SegmentationReceive(SOCKET receiver, char** obyte_stream, int* ostream_len);
